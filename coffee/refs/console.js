//see https://github.com/jsoverson/jsconsole
...
var Console = (function () {
  var Console = (function () {
    function Console(element) {
      ...
      options = arguments[1] === undefined ? {} : arguments[1];

      _classCallCheck(this, Console);

      options.theme = options.theme || 'eclipse';
      options.mode = options.mode || 'javascript';
      options.outputH = options.outputH || 'auto';
      ...
      this.output.setSize(null, options.outputH);
      this.resetOutput();
