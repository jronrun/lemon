...
(function(root, core, component) {
	...
	var proto = null; proto = function(input) {
		return proto.isEncoded(input) ? proto.decode(input) : proto.encode(input);
	};
	
	var keyStr = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=";
	proto.encode = function(input) {
		input = escape(input); var output = "";
	...
	proto.decode = function(input) {
		var output = ""; var chr1, chr2, chr3 = ""; var enc1, enc2, enc3, enc4 = ""; var i = 0;
		// remove all characters that are not A-Z, a-z, 0-9, +, /, or =
		var base64test = /[^A-Za-z0-9\+\/\=]/g;
		if (base64test.exec(input)) {
			core.warn("There were invalid base64 characters in the input text.\n"
	...
	proto.isEncoded = function(input) {
		return /^(?:[A-Za-z0-9+/]{4})*(?:[A-Za-z0-9+/]{2}==|[A-Za-z0-9+/]{3}=|[A-Za-z0-9+/]{4})$/.test(input);
	};
